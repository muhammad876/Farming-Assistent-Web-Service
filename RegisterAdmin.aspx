<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterAdmin.aspx.cs" Inherits="_160245.RegisterAdmin" %>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6">
               ...
               <br /> <br /> <asp:TextBox ID="TextBox1" runat="server" class="form-control" type="password"  placeholder="passward"></asp:TextBox>
               ...
               <br /> <br /> <asp:TextBox ID="TextBox2" runat="server" class="form-control" type="password" placeholder="confirm passward"></asp:TextBox>
