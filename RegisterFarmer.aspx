<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterFarmer.aspx.cs" Inherits="_160245.RegisterFarmer" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
               <asp:HyperLink id="hyper" runat="server" >ID:</asp:HyperLink>
