...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <br /><br />  <br /><br />
    <div class="container">
        <a href="addAdvertisment.aspx">addAdvertisment</a>
        <div class="row">
            <div class="col-lg-3">
               <asp:HyperLink id="hyper" runat="server" >Crop Id:</asp:HyperLink>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Please Enter name" ControlToValidate="t1"></asp:RequiredFieldValidator>
                 ...
                 <br /> <br />  <asp:HyperLink id="HyperLink1" runat="server" >Crop Name:</asp:HyperLink>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please Enter name" ControlToValidate="t2"></asp:RequiredFieldValidator>
                    ...
                    <br /> <br />  <asp:HyperLink id="HyperLink2" runat="server" >Quantity:</asp:HyperLink>
